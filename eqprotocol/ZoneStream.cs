...
namespace OpenEQ.Netcode
{
    public class ZoneStream : EQStream
    {
        ...
        public event EventHandler<ClientTarget> Assist;
        ...
        protected override void HandleAppPacket(AppPacket packet)
        {
            ...
            switch ((ZoneOp)packet.Opcode)
            {
                ...
                case ZoneOp.DeleteSpawn:
                    var deleteSpawn = packet.Get<EntityId>();
                ...
                case ZoneOp.Assist:
                    var assist = new ClientTarget(packet.Data);
                    Logger.Debug($"Zone | Assist - Target: {assist.NewTarget}");

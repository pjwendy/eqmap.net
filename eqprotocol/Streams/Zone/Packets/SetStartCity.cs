...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct SetStartCity : IEQStruct {
		/// <summary>
		...
		public SetStartCity(uint[] filters) : this() {
			Filters = filters;
		}
		...
		public SetStartCity(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public SetStartCity(BinaryReader br) : this() {
			Unpack(br);
		}

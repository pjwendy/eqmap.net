...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct FriendsWho : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the FriendsWho struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public FriendsWho() : this() {
		...
		public FriendsWho(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public FriendsWho(BinaryReader br) : this() {
			Unpack(br);
		}

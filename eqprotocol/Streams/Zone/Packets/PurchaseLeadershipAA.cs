...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct PurchaseLeadershipAA : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the PurchaseLeadershipAA struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public PurchaseLeadershipAA() : this() {
		...
		public PurchaseLeadershipAA(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public PurchaseLeadershipAA(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct PurchaseLeadershipAA {\n";
						ret += "	// No properties\n";
			ret += "}";

...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct SetTitle : IEQStruct {
		/// <summary>
		...
		public SetTitle(uint is_suffix, byte[] title, uint entity_id) : this() {
			IsSuffix = is_suffix;
			Title = title;
			EntityId = entity_id;
		}
		...
		public SetTitle(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public SetTitle(BinaryReader br) : this() {
			Unpack(br);
		}

...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct GuildMemberPublicNote : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the GuildMemberPublicNote struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public GuildMemberPublicNote() : this() {
		...
		public GuildMemberPublicNote(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public GuildMemberPublicNote(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct GuildMemberPublicNote {\n";
						ret += "	// No properties\n";
			ret += "}";

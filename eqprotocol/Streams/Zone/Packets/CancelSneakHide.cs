...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct CancelSneakHide : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the CancelSneakHide struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public CancelSneakHide() : this() {
		...
		public CancelSneakHide(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public CancelSneakHide(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct CancelSneakHide {\n";
						ret += "	// No properties\n";
			ret += "}";

...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct LootRequest : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the LootRequest struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public LootRequest() : this() {
		...
		public LootRequest(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public LootRequest(BinaryReader br) : this() {
			Unpack(br);
		}

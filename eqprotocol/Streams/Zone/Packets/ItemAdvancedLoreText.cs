...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct ItemAdvancedLoreText : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the ItemAdvancedLoreText struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public ItemAdvancedLoreText() : this() {
		...
		public ItemAdvancedLoreText(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public ItemAdvancedLoreText(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct ItemAdvancedLoreText {\n";
						ret += "	// No properties\n";
			ret += "}";

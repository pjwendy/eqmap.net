...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct TrackTarget : IEQStruct {
		/// <summary>
		...
		public TrackTarget(uint EntityID) : this() {
			Entityid = EntityID;
		}
		...
		public TrackTarget(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public TrackTarget(BinaryReader br) : this() {
			Unpack(br);
		}

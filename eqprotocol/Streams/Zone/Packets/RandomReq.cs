...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct RandomReq : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the RandomReq struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public RandomReq() : this() {
		...
		public RandomReq(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public RandomReq(BinaryReader br) : this() {
			Unpack(br);
		}

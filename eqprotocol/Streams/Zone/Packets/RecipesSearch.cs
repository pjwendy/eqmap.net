...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct RecipesSearch : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the RecipesSearch struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public RecipesSearch() : this() {
		...
		public RecipesSearch(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public RecipesSearch(BinaryReader br) : this() {
			Unpack(br);
		}

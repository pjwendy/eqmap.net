...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct GuildMemberLevel : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the GuildMemberLevel struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public GuildMemberLevel() : this() {
		...
		public GuildMemberLevel(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public GuildMemberLevel(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct GuildMemberLevel {\n";
						ret += "	// No properties\n";
			ret += "}";

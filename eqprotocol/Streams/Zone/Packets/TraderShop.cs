...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct TraderShop : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the TraderShop struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public TraderShop() : this() {
		...
		public TraderShop(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public TraderShop(BinaryReader br) : this() {
			Unpack(br);
		}

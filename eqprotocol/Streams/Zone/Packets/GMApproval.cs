...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct GMApproval : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the GMApproval struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public GMApproval() : this() {
		...
		public GMApproval(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public GMApproval(BinaryReader br) : this() {
			Unpack(br);
		}

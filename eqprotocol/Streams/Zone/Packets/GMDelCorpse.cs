...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct GMDelCorpse : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the GMDelCorpse struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public GMDelCorpse() : this() {
		...
		public GMDelCorpse(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public GMDelCorpse(BinaryReader br) : this() {
			Unpack(br);
		}

...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct MobManaUpdate : IEQStruct {
		/// <summary>
		...
		public MobManaUpdate(ushort spawn_id, byte mana) : this() {
			SpawnId = spawn_id;
			Mana = mana;
		}
		...
		public MobManaUpdate(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public MobManaUpdate(BinaryReader br) : this() {
			Unpack(br);
		}

...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct InstillDoubt : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the InstillDoubt struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public InstillDoubt() : this() {
		...
		public InstillDoubt(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public InstillDoubt(BinaryReader br) : this() {
			Unpack(br);
		}

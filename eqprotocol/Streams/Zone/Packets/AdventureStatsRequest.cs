...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct AdventureStatsRequest : IEQStruct {
		/// <summary>
		...
		public AdventureStatsRequest(uint success, uint failure, uint rank, uint rank2) : this() {
			Success = success;
			Failure = failure;
			Rank = rank;
			Rank2 = rank2;
		...
		public AdventureStatsRequest(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public AdventureStatsRequest(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct AdventureStatsRequest {\n";
			ret += "	Success = ";
			try {

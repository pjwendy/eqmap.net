...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct Logout : IEQStruct {
		/// <summary>
		...
		public Logout(uint entity_id) : this() {
			EntityId = entity_id;
		}
		...
		public Logout(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public Logout(BinaryReader br) : this() {
			Unpack(br);
		}

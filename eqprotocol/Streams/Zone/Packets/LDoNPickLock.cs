...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct LDoNPickLock : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the LDoNPickLock struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public LDoNPickLock() : this() {
		...
		public LDoNPickLock(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public LDoNPickLock(BinaryReader br) : this() {
			Unpack(br);
		}

...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct OpenContainer : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the OpenContainer struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public OpenContainer() : this() {
		...
		public OpenContainer(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public OpenContainer(BinaryReader br) : this() {
			Unpack(br);
		}

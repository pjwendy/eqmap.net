...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct DzMakeLeader : IEQStruct {
		/// <summary>
		...
		public DzMakeLeader(uint unknown000, uint unknown004, byte[] name) : this() {
		...
		public DzMakeLeader(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public DzMakeLeader(BinaryReader br) : this() {
			Unpack(br);
		}

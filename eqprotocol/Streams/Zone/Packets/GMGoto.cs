...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct GMGoto : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the GMGoto struct with specified field values.
		/// </summary>
		...
		public GMGoto(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public GMGoto(BinaryReader br) : this() {
			Unpack(br);
		}

...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct InitialMobHealth : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the InitialMobHealth struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public InitialMobHealth() : this() {
		...
		public InitialMobHealth(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public InitialMobHealth(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct InitialMobHealth {\n";
						ret += "	// No properties\n";
			ret += "}";

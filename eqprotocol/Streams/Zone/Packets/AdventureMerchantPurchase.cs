...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct AdventureMerchantPurchase : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the AdventureMerchantPurchase struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public AdventureMerchantPurchase() : this() {
		...
		public AdventureMerchantPurchase(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public AdventureMerchantPurchase(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct AdventureMerchantPurchase {\n";
						ret += "	// No properties\n";
			ret += "}";

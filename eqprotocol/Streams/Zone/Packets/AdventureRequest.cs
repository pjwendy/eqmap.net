...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct AdventureRequest : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the AdventureRequest struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public AdventureRequest() : this() {
		...
		public AdventureRequest(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public AdventureRequest(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct AdventureRequest {\n";
						ret += "	// No properties\n";
			ret += "}";

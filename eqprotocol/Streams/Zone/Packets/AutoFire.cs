...
namespace OpenEQ.Netcode {
	...
	public struct AutoFire : IEQStruct {
		...
		public AutoFire(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public AutoFire(BinaryReader br) : this() {
			Unpack(br);
		}

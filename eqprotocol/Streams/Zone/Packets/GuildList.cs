...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct GuildList : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the GuildList struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public GuildList() : this() {
		...
		public GuildList(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public GuildList(BinaryReader br) : this() {
			Unpack(br);
		}

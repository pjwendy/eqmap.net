...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct NewTitlesAvailable : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the NewTitlesAvailable struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public NewTitlesAvailable() : this() {
		...
		public NewTitlesAvailable(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public NewTitlesAvailable(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct NewTitlesAvailable {\n";
						ret += "	// No properties\n";
			ret += "}";

...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct GMTraining : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the GMTraining struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public GMTraining() : this() {
		...
		public GMTraining(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public GMTraining(BinaryReader br) : this() {
			Unpack(br);
		}

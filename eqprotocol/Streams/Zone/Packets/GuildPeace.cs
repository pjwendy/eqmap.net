...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct GuildPeace : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the GuildPeace struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public GuildPeace() : this() {
		...
		public GuildPeace(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public GuildPeace(BinaryReader br) : this() {
			Unpack(br);
		}

...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct GMZoneRequest2 : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the GMZoneRequest2 struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public GMZoneRequest2() : this() {
		...
		public GMZoneRequest2(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public GMZoneRequest2(BinaryReader br) : this() {
			Unpack(br);
		}

...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct SendExpZonein : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the SendExpZonein struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public SendExpZonein() : this() {
		...
		public SendExpZonein(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public SendExpZonein(BinaryReader br) : this() {
			Unpack(br);
		}

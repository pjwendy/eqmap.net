...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct AltCurrencyMerchantRequest : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the AltCurrencyMerchantRequest struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public AltCurrencyMerchantRequest() : this() {
		...
		public AltCurrencyMerchantRequest(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public AltCurrencyMerchantRequest(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct AltCurrencyMerchantRequest {\n";
						ret += "	// No properties\n";
			ret += "}";

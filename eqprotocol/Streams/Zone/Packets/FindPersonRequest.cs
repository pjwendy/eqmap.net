...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct FindPersonRequest : IEQStruct {
		/// <summary>
		...
		public FindPersonRequest(uint unknown000, uint npc_id, uint client_pos, uint unknown020) : this() {
		...
		public FindPersonRequest(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public FindPersonRequest(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct FindPersonRequest {\n";
			ret += "	Unknown000 = ";
			try {

...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct CrystalReclaim : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the CrystalReclaim struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public CrystalReclaim() : this() {
		...
		public CrystalReclaim(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public CrystalReclaim(BinaryReader br) : this() {
			Unpack(br);
		}

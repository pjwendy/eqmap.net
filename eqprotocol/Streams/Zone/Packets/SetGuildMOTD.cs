...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct SetGuildMOTD : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the SetGuildMOTD struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public SetGuildMOTD() : this() {
		...
		public SetGuildMOTD(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public SetGuildMOTD(BinaryReader br) : this() {
			Unpack(br);
		}

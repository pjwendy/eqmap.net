...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct TaskActivityComplete : IEQStruct {
		/// <summary>
		...
		public TaskActivityComplete(uint TaskIndex, uint unknown2, uint unknown3, uint ActivityID, uint unknown4, uint unknown5) : this() {
			Taskindex = TaskIndex;
			Unknown2 = unknown2;
			Unknown3 = unknown3;
		...
		public TaskActivityComplete(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public TaskActivityComplete(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct TaskActivityComplete {\n";
			ret += "	Taskindex = ";
			try {

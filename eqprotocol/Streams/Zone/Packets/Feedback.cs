...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct Feedback : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the Feedback struct with specified field values.
		/// </summary>
		...
		public Feedback(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public Feedback(BinaryReader br) : this() {
			Unpack(br);
		}

...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct ClearRaidNPCMarks : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the ClearRaidNPCMarks struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public ClearRaidNPCMarks() : this() {
		...
		public ClearRaidNPCMarks(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public ClearRaidNPCMarks(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct ClearRaidNPCMarks {\n";
						ret += "	// No properties\n";
			ret += "}";

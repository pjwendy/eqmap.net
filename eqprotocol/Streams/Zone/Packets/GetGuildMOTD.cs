...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct GetGuildMOTD : IEQStruct {
		/// <summary>
		...
		public GetGuildMOTD(uint unknown0, byte[] name, byte[] setby_name, uint unknown132, byte motd) : this() {
			Unknown0 = unknown0;
			Name = name;
		...
		public GetGuildMOTD(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public GetGuildMOTD(BinaryReader br) : this() {
			Unpack(br);
		}

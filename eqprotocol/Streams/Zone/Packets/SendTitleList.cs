...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct SendTitleList : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the SendTitleList struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public SendTitleList() : this() {
		...
		public SendTitleList(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public SendTitleList(BinaryReader br) : this() {
			Unpack(br);
		}

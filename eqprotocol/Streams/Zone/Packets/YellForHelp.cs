...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct YellForHelp : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the YellForHelp struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public YellForHelp() : this() {
		...
		public YellForHelp(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public YellForHelp(BinaryReader br) : this() {
			Unpack(br);
		}

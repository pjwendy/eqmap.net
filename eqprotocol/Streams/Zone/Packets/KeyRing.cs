...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct KeyRing : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the KeyRing struct with specified field values.
		/// </summary>
		...
		public KeyRing(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public KeyRing(BinaryReader br) : this() {
			Unpack(br);
		}

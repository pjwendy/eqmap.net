...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct DzPlayerList : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the DzPlayerList struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public DzPlayerList() : this() {
		...
		public DzPlayerList(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public DzPlayerList(BinaryReader br) : this() {
			Unpack(br);
		}

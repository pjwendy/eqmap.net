...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct PlayerStateRemove : IEQStruct {
		/// <summary>
		...
		public PlayerStateRemove(uint spawn_id, uint state) : this() {
			SpawnId = spawn_id;
			State = state;
		}
		...
		public PlayerStateRemove(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public PlayerStateRemove(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct PlayerStateRemove {\n";
			ret += "	SpawnId = ";
			try {

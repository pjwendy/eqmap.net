...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct MoveDoor : IEQStruct {
		/// <summary>
		...
		public MoveDoor(byte doorid, byte action) : this() {
			Doorid = doorid;
			Action = action;
		}
		...
		public MoveDoor(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public MoveDoor(BinaryReader br) : this() {
			Unpack(br);
		}

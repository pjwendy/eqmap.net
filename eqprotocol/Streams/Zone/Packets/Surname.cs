...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct Surname : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the Surname struct with specified field values.
		/// </summary>
		...
		public Surname(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public Surname(BinaryReader br) : this() {
			Unpack(br);
		}

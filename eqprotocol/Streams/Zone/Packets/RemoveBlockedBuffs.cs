...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct RemoveBlockedBuffs : IEQStruct {
		/// <summary>
		...
		public RemoveBlockedBuffs(byte[] unknown000, byte unknown081, byte unknown082, byte unknown083, byte unknown084, byte unknown085, byte unknown086, byte unknown087, byte unknown088) : this() {
		...
		public RemoveBlockedBuffs(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public RemoveBlockedBuffs(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct RemoveBlockedBuffs {\n";
			ret += "	Unknown000 = ";
			try {

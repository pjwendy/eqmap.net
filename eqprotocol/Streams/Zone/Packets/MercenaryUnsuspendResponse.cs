...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct MercenaryUnsuspendResponse : IEQStruct {
		/// <summary>
		/// Gets or sets the suspendtime value.
		/// </summary>
		public uint Suspendtime { get; set; }
		...
		public MercenaryUnsuspendResponse(uint SuspendTime) : this() {
		...
		public MercenaryUnsuspendResponse(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public MercenaryUnsuspendResponse(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct MercenaryUnsuspendResponse {\n";
			ret += "	Suspendtime = ";
			try {
				ret += $"{ Indentify(Suspendtime) },\n";

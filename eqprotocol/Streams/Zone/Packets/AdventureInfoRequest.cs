...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct AdventureInfoRequest : IEQStruct {
		/// <summary>
		...
		public AdventureInfoRequest(uint entity_id) : this() {
			EntityId = entity_id;
		}
		...
		public AdventureInfoRequest(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public AdventureInfoRequest(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct AdventureInfoRequest {\n";
			ret += "	EntityId = ";
			try {

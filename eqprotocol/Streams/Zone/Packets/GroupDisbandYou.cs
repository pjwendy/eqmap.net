...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct GroupDisbandYou : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the GroupDisbandYou struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public GroupDisbandYou() : this() {
		...
		public GroupDisbandYou(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public GroupDisbandYou(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct GroupDisbandYou {\n";
						ret += "	// No properties\n";
			ret += "}";

...
namespace OpenEQ.Netcode {
	...
	public struct GMHideMe : IEQStruct {
		...
		public GMHideMe(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public GMHideMe(BinaryReader br) : this() {
			Unpack(br);
		}

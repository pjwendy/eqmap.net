...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct GetGuildMOTDReply : IEQStruct {
		/// <summary>
		...
		public GetGuildMOTDReply(uint unknown0, byte[] name, byte[] setby_name, uint unknown132, byte motd) : this() {
			Unknown0 = unknown0;
			Name = name;
		...
		public GetGuildMOTDReply(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public GetGuildMOTDReply(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct GetGuildMOTDReply {\n";
			ret += "	Unknown0 = ";
			try {

...
namespace OpenEQ.Netcode {
	...
	public struct NewSpawn : IEQStruct {
		...
		public NewSpawn(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public NewSpawn(BinaryReader br) : this() {
			Unpack(br);
		}

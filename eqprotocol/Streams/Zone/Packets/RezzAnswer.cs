...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct RezzAnswer : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the RezzAnswer struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public RezzAnswer() : this() {
		...
		public RezzAnswer(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public RezzAnswer(BinaryReader br) : this() {
			Unpack(br);
		}

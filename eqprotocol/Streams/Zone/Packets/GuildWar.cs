...
namespace OpenEQ.Netcode {
	...
	public struct GuildWar : IEQStruct {
		...
		public GuildWar(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public GuildWar(BinaryReader br) : this() {
			Unpack(br);
		}

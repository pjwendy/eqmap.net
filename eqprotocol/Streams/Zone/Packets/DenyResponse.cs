...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct DenyResponse : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the DenyResponse struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public DenyResponse() : this() {
		...
		public DenyResponse(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public DenyResponse(BinaryReader br) : this() {
			Unpack(br);
		}

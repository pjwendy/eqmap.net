...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct ItemLinkResponse : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the ItemLinkResponse struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public ItemLinkResponse() : this() {
		...
		public ItemLinkResponse(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public ItemLinkResponse(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct ItemLinkResponse {\n";
						ret += "	// No properties\n";
			ret += "}";

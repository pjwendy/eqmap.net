...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct Dye : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the Dye struct with specified field values.
		/// </summary>
		...
		public Dye(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public Dye(BinaryReader br) : this() {
			Unpack(br);
		}

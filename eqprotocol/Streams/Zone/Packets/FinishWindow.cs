...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct FinishWindow : IEQStruct {
		/// <summary>
		...
		public FinishWindow(byte type, byte[] character_name, byte[] unknown134, byte[] message) : this() {
			Type = type;
		...
		public FinishWindow(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public FinishWindow(BinaryReader br) : this() {
			Unpack(br);
		}

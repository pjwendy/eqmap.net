...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct XTargetOpenResponse : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the XTargetOpenResponse struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public XTargetOpenResponse() : this() {
		...
		public XTargetOpenResponse(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public XTargetOpenResponse(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct XTargetOpenResponse {\n";
						ret += "	// No properties\n";
			ret += "}";

...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct SetGroupTarget : IEQStruct {
		/// <summary>
		...
		public SetGroupTarget(uint TargetID, uint Number, byte[] Name) : this() {
			Targetid = TargetID;
			Number = Number;
			Name = Name;
		}
		...
		public SetGroupTarget(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public SetGroupTarget(BinaryReader br) : this() {
			Unpack(br);
		}

...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct ConsiderCorpse : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the ConsiderCorpse struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public ConsiderCorpse() : this() {
		...
		public ConsiderCorpse(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public ConsiderCorpse(BinaryReader br) : this() {
			Unpack(br);
		}

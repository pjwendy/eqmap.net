...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct AdventureDetails : IEQStruct {
		/// <summary>
		...
		public AdventureDetails(uint current, uint total) : this() {
			Current = current;
			Total = total;
		}
		...
		public AdventureDetails(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public AdventureDetails(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct AdventureDetails {\n";
			ret += "	Current = ";
			try {

...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct Jump : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the Jump struct with specified field values.
		/// </summary>
		...
		public Jump(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public Jump(BinaryReader br) : this() {
			Unpack(br);
		}

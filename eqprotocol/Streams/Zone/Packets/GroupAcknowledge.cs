...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct GroupAcknowledge : IEQStruct {
		/// <summary>
		...
		public GroupAcknowledge(byte[] Unknown000, byte[] LeaderName, byte[] Unknown128) : this() {
		...
		public GroupAcknowledge(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public GroupAcknowledge(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct GroupAcknowledge {\n";
			ret += "	Unknown000 = ";
			try {

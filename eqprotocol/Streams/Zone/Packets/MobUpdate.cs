...
namespace OpenEQ.Netcode
{
    ...
    /// </summary>
    public struct MobUpdate : IEQStruct
    {
        public ushort ID;
        public UpdatePositionFromServer Position;

        public MobUpdate(ushort ID, UpdatePositionFromServer Position) : this()
        {
            this.ID = ID;
            this.Position = Position;
        }

        public MobUpdate(byte[] data, int offset = 0) : this()
        {
            Unpack(data, offset);
        }
        public MobUpdate(BinaryReader br) : this()
        {
            Unpack(br);
        }
        public void Unpack(byte[] data, int offset = 0)

...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct OpenGuildTributeMaster : IEQStruct {
		/// <summary>
		...
		public OpenGuildTributeMaster(uint client_id, uint tribute_master_id, uint response) : this() {
			ClientId = client_id;
		...
		public OpenGuildTributeMaster(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public OpenGuildTributeMaster(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct OpenGuildTributeMaster {\n";
			ret += "	ClientId = ";
			try {

...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct LFGGetMatchesResponse : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the LFGGetMatchesResponse struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public LFGGetMatchesResponse() : this() {
		...
		public LFGGetMatchesResponse(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public LFGGetMatchesResponse(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct LFGGetMatchesResponse {\n";
						ret += "	// No properties\n";
			ret += "}";

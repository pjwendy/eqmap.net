...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct RezzComplete : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the RezzComplete struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public RezzComplete() : this() {
		...
		public RezzComplete(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public RezzComplete(BinaryReader br) : this() {
			Unpack(br);
		}

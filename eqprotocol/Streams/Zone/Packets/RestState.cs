...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct RestState : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the RestState struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public RestState() : this() {
		...
		public RestState(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public RestState(BinaryReader br) : this() {
			Unpack(br);
		}

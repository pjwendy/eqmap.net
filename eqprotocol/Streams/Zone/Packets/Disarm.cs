...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct Disarm : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the Disarm struct with specified field values.
		/// </summary>
		...
		public Disarm(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public Disarm(BinaryReader br) : this() {
			Unpack(br);
		}

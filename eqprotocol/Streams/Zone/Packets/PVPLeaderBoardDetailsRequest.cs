...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct PVPLeaderBoardDetailsRequest : IEQStruct {
		/// <summary>
		...
		public PVPLeaderBoardDetailsRequest(byte[] Name, byte[] Unknown064, uint Level, uint Race, uint Class, uint GuildID, uint TotalAA, uint Unknown148, uint Kills, uint Deaths, uint Infamy, uint Points) : this() {
			Name = Name;
		...
		public PVPLeaderBoardDetailsRequest(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public PVPLeaderBoardDetailsRequest(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct PVPLeaderBoardDetailsRequest {\n";
			ret += "	Name = ";
			try {
				ret += $"{ Indentify(Name) },\n";

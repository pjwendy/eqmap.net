...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct MercenaryDismiss : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the MercenaryDismiss struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public MercenaryDismiss() : this() {
		...
		public MercenaryDismiss(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public MercenaryDismiss(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct MercenaryDismiss {\n";
						ret += "	// No properties\n";
			ret += "}";

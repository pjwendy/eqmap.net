...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct AdventureLeaderboardReply : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the AdventureLeaderboardReply struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public AdventureLeaderboardReply() : this() {
		...
		public AdventureLeaderboardReply(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public AdventureLeaderboardReply(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct AdventureLeaderboardReply {\n";
						ret += "	// No properties\n";
			ret += "}";

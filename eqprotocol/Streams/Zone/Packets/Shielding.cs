...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct Shielding : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the Shielding struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public Shielding() : this() {
		...
		public Shielding(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public Shielding(BinaryReader br) : this() {
			Unpack(br);
		}

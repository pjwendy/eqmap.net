...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct GMEmoteWorld : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the GMEmoteWorld struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public GMEmoteWorld() : this() {
		...
		public GMEmoteWorld(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public GMEmoteWorld(BinaryReader br) : this() {
			Unpack(br);
		}

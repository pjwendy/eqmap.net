...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct WorldObjectsSent : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the WorldObjectsSent struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public WorldObjectsSent() : this() {
		...
		public WorldObjectsSent(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public WorldObjectsSent(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct WorldObjectsSent {\n";
						ret += "	// No properties\n";
			ret += "}";

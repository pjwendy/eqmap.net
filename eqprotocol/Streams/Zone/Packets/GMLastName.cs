...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct GMLastName : IEQStruct {
		/// <summary>
		...
		public GMLastName(byte[] name, byte[] gmname, byte[] lastname, ushort[] unknown) : this() {
			Name = name;
			Gmname = gmname;
			Lastname = lastname;
			Unknown = unknown;
		...
		public GMLastName(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public GMLastName(BinaryReader br) : this() {
			Unpack(br);
		}

...
namespace OpenEQ.Netcode {
	...
	public struct TestBuff : IEQStruct {
		...
		public TestBuff(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public TestBuff(BinaryReader br) : this() {
			Unpack(br);
		}

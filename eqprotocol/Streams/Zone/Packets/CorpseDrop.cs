...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct CorpseDrop : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the CorpseDrop struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public CorpseDrop() : this() {
		...
		public CorpseDrop(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public CorpseDrop(BinaryReader br) : this() {
			Unpack(br);
		}

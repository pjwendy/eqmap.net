...
namespace OpenEQ.Netcode {
	...
	public struct UpdateAA : IEQStruct {
		...
		public UpdateAA(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public UpdateAA(BinaryReader br) : this() {
			Unpack(br);
		}

...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct LeaveAdventure : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the LeaveAdventure struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public LeaveAdventure() : this() {
		...
		public LeaveAdventure(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public LeaveAdventure(BinaryReader br) : this() {
			Unpack(br);
		}

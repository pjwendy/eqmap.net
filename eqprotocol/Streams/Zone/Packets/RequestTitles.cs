...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct RequestTitles : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the RequestTitles struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public RequestTitles() : this() {
		...
		public RequestTitles(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public RequestTitles(BinaryReader br) : this() {
			Unpack(br);
		}

...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct SetFace : IEQStruct {
		/// <summary>
		...
		public SetFace(byte haircolor, byte beardcolor, byte eyecolor1, byte eyecolor2, byte hairstyle, byte beard, byte face, byte unused_padding, uint drakkin_heritage, uint drakkin_tattoo, uint drakkin_details, uint entity_id) : this() {
			Haircolor = haircolor;
		...
		public SetFace(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public SetFace(BinaryReader br) : this() {
			Unpack(br);
		}

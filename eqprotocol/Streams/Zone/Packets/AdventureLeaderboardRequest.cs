...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct AdventureLeaderboardRequest : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the AdventureLeaderboardRequest struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public AdventureLeaderboardRequest() : this() {
		...
		public AdventureLeaderboardRequest(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public AdventureLeaderboardRequest(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct AdventureLeaderboardRequest {\n";
						ret += "	// No properties\n";
			ret += "}";

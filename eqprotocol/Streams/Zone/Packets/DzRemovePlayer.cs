...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct DzRemovePlayer : IEQStruct {
		/// <summary>
		...
		public DzRemovePlayer(uint unknown000, uint unknown004, byte[] name) : this() {
		...
		public DzRemovePlayer(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public DzRemovePlayer(BinaryReader br) : this() {
			Unpack(br);
		}

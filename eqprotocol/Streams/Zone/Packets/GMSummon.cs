...
namespace OpenEQ.Netcode {
	...
	public struct GMSummon : IEQStruct {
		...
		public GMSummon(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public GMSummon(BinaryReader br) : this() {
			Unpack(br);
		}

...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct Bug : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the Bug struct with specified field values.
		/// </summary>
		...
		public Bug(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public Bug(BinaryReader br) : this() {
			Unpack(br);
		}

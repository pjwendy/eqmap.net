...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct GroupFollow2 : IEQStruct {
		/// <summary>
		...
		public GroupFollow2(byte[] name1, byte[] name2) : this() {
			Name1 = name1;
			Name2 = name2;
		}
		...
		public GroupFollow2(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public GroupFollow2(BinaryReader br) : this() {
			Unpack(br);
		}

...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct SelectTribute : IEQStruct {
		/// <summary>
		...
		public SelectTribute(uint client_id, uint tribute_id, uint unknown8) : this() {
			ClientId = client_id;
		...
		public SelectTribute(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public SelectTribute(BinaryReader br) : this() {
			Unpack(br);
		}

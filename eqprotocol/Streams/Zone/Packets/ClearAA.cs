...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct ClearAA : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the ClearAA struct with specified field values.
		/// </summary>
		...
		public ClearAA(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public ClearAA(BinaryReader br) : this() {
			Unpack(br);
		}

...
namespace OpenEQ.Netcode {
	...
	public struct MoveCoin : IEQStruct {
		...
		public MoveCoin(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public MoveCoin(BinaryReader br) : this() {
			Unpack(br);
		}

...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct AdventureMerchantResponse : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the AdventureMerchantResponse struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public AdventureMerchantResponse() : this() {
		...
		public AdventureMerchantResponse(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public AdventureMerchantResponse(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct AdventureMerchantResponse {\n";
						ret += "	// No properties\n";
			ret += "}";

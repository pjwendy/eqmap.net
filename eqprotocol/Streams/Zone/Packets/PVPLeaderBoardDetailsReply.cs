...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct PVPLeaderBoardDetailsReply : IEQStruct {
		/// <summary>
		...
		public PVPLeaderBoardDetailsReply(byte[] Name, byte[] Unknown064, uint Level, uint Race, uint Class, uint GuildID, uint TotalAA, uint Unknown148, uint Kills, uint Deaths, uint Infamy, uint Points) : this() {
			Name = Name;
		...
		public PVPLeaderBoardDetailsReply(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public PVPLeaderBoardDetailsReply(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct PVPLeaderBoardDetailsReply {\n";
			ret += "	Name = ";
			try {
				ret += $"{ Indentify(Name) },\n";

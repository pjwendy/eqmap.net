...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct HideCorpse : IEQStruct {
		/// <summary>
		...
		public HideCorpse(uint Action, uint Unknown04) : this() {
			Action = Action;
			Unknown04 = Unknown04;
		}
		...
		public HideCorpse(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public HideCorpse(BinaryReader br) : this() {
			Unpack(br);
		}

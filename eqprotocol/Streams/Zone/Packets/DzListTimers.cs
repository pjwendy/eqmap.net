...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct DzListTimers : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the DzListTimers struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public DzListTimers() : this() {
		...
		public DzListTimers(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public DzListTimers(BinaryReader br) : this() {
			Unpack(br);
		}

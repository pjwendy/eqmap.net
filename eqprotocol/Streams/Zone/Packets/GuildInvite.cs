...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct GuildInvite : IEQStruct {
		/// <summary>
		...
		public GuildInvite(byte[] othername, byte[] myname, ushort guildeqid, byte[] unknown, uint officer) : this() {
			Othername = othername;
			Myname = myname;
			Guildeqid = guildeqid;
			Unknown = unknown;
		...
		public GuildInvite(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public GuildInvite(BinaryReader br) : this() {
			Unpack(br);
		}

...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct MarkNPC : IEQStruct {
		/// <summary>
		...
		public MarkNPC(uint TargetID, uint Number, byte[] Name) : this() {
			Targetid = TargetID;
			Number = Number;
			Name = Name;
		}
		...
		public MarkNPC(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public MarkNPC(BinaryReader br) : this() {
			Unpack(br);
		}

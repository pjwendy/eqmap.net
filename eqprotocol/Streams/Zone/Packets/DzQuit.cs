...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct DzQuit : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the DzQuit struct with specified field values.
		/// </summary>
		...
		public DzQuit(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public DzQuit(BinaryReader br) : this() {
			Unpack(br);
		}

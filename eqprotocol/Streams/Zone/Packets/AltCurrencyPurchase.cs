...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct AltCurrencyPurchase : IEQStruct {
		/// <summary>
		...
		public AltCurrencyPurchase(uint merchant_entity_id, uint item_id, uint unknown008) : this() {
		...
		public AltCurrencyPurchase(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public AltCurrencyPurchase(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct AltCurrencyPurchase {\n";

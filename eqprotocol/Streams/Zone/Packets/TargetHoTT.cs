...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct TargetHoTT : IEQStruct {
		/// <summary>
		...
		public TargetHoTT(uint new_target) : this() {
		...
		public TargetHoTT(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public TargetHoTT(BinaryReader br) : this() {
			Unpack(br);
		}

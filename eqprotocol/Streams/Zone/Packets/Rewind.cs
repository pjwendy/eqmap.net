...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct Rewind : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the Rewind struct with specified field values.
		/// </summary>
		...
		public Rewind(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public Rewind(BinaryReader br) : this() {
			Unpack(br);
		}

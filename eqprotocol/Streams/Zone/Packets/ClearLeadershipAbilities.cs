...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct ClearLeadershipAbilities : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the ClearLeadershipAbilities struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public ClearLeadershipAbilities() : this() {
		...
		public ClearLeadershipAbilities(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public ClearLeadershipAbilities(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct ClearLeadershipAbilities {\n";
						ret += "	// No properties\n";
			ret += "}";

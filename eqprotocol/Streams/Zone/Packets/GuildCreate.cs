...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct GuildCreate : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the GuildCreate struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public GuildCreate() : this() {
		...
		public GuildCreate(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public GuildCreate(BinaryReader br) : this() {
			Unpack(br);
		}

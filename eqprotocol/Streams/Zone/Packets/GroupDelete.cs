...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct GroupDelete : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the GroupDelete struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public GroupDelete() : this() {
		...
		public GroupDelete(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public GroupDelete(BinaryReader br) : this() {
			Unpack(br);
		}

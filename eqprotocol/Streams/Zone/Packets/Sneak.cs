...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct Sneak : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the Sneak struct with specified field values.
		/// </summary>
		...
		public Sneak(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public Sneak(BinaryReader br) : this() {
			Unpack(br);
		}

...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct TributeToggle : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the TributeToggle struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public TributeToggle() : this() {
		...
		public TributeToggle(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public TributeToggle(BinaryReader br) : this() {
			Unpack(br);
		}

...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct FloatListThing : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the FloatListThing struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public FloatListThing() : this() {
		...
		public FloatListThing(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public FloatListThing(BinaryReader br) : this() {
			Unpack(br);
		}

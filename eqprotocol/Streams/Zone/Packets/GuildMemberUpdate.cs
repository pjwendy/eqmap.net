...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct GuildMemberUpdate : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the GuildMemberUpdate struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public GuildMemberUpdate() : this() {
		...
		public GuildMemberUpdate(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public GuildMemberUpdate(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct GuildMemberUpdate {\n";
						ret += "	// No properties\n";
			ret += "}";

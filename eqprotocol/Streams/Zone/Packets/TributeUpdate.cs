...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct TributeUpdate : IEQStruct {
		/// <summary>
		...
		public TributeUpdate(uint active, uint tributes, uint tiers, uint tribute_master_id) : this() {
			Active = active;
			Tributes = tributes;
			Tiers = tiers;
		...
		public TributeUpdate(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public TributeUpdate(BinaryReader br) : this() {
			Unpack(br);
		}

...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct GMKill : IEQStruct {
		/// <summary>
		...
		public GMKill(byte[] name, byte[] gmname, byte unknown) : this() {
			Name = name;
			Gmname = gmname;
			Unknown = unknown;
		}
		...
		public GMKill(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public GMKill(BinaryReader br) : this() {
			Unpack(br);
		}

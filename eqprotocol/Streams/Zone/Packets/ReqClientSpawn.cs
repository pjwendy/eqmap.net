...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct ReqClientSpawn : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the ReqClientSpawn struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public ReqClientSpawn() : this() {
		...
		public ReqClientSpawn(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public ReqClientSpawn(BinaryReader br) : this() {
			Unpack(br);
		}

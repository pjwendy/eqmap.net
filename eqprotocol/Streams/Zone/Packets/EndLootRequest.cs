...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct EndLootRequest : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the EndLootRequest struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public EndLootRequest() : this() {
		...
		public EndLootRequest(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public EndLootRequest(BinaryReader br) : this() {
			Unpack(br);
		}

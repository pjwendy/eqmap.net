...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct Trader : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the Trader struct with specified field values.
		/// </summary>
		...
		public Trader(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public Trader(BinaryReader br) : this() {
			Unpack(br);
		}

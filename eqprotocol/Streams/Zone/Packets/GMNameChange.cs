...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct GMNameChange : IEQStruct {
		/// <summary>
		...
		public GMNameChange(byte[] oldname, byte[] gmname, byte[] newname, byte badname, byte[] unknown) : this() {
			Oldname = oldname;
			Gmname = gmname;
			Newname = newname;
			Badname = badname;
		...
		public GMNameChange(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public GMNameChange(BinaryReader br) : this() {
			Unpack(br);
		}

...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct ShopEndConfirm : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the ShopEndConfirm struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public ShopEndConfirm() : this() {
		...
		public ShopEndConfirm(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public ShopEndConfirm(BinaryReader br) : this() {
			Unpack(br);
		}

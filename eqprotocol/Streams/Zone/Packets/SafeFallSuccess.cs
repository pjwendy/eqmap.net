...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct SafeFallSuccess : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the SafeFallSuccess struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public SafeFallSuccess() : this() {
		...
		public SafeFallSuccess(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public SafeFallSuccess(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct SafeFallSuccess {\n";
						ret += "	// No properties\n";
			ret += "}";

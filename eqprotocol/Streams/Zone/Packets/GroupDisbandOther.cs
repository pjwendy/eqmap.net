...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct GroupDisbandOther : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the GroupDisbandOther struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public GroupDisbandOther() : this() {
		...
		public GroupDisbandOther(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public GroupDisbandOther(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct GroupDisbandOther {\n";
						ret += "	// No properties\n";
			ret += "}";

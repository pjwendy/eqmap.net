...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct RespawnWindow : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the RespawnWindow struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public RespawnWindow() : this() {
		...
		public RespawnWindow(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public RespawnWindow(BinaryReader br) : this() {
			Unpack(br);
		}

...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct SenseTraps : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the SenseTraps struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public SenseTraps() : this() {
		...
		public SenseTraps(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public SenseTraps(BinaryReader br) : this() {
			Unpack(br);
		}

...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct TradeRequestAck : IEQStruct {
		/// <summary>
		...
		public TradeRequestAck(uint to_mob_id, uint from_mob_id) : this() {
			ToMobId = to_mob_id;
		...
		public TradeRequestAck(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public TradeRequestAck(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct TradeRequestAck {\n";
			ret += "	ToMobId = ";
			try {

...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct WeaponEquip1 : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the WeaponEquip1 struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public WeaponEquip1() : this() {
		...
		public WeaponEquip1(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public WeaponEquip1(BinaryReader br) : this() {
			Unpack(br);
		}

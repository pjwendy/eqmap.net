...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct TargetBuffs : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the TargetBuffs struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public TargetBuffs() : this() {
		...
		public TargetBuffs(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public TargetBuffs(BinaryReader br) : this() {
			Unpack(br);
		}

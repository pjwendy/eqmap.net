...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct SendTributes : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the SendTributes struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public SendTributes() : this() {
		...
		public SendTributes(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public SendTributes(BinaryReader br) : this() {
			Unpack(br);
		}

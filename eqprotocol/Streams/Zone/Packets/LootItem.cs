...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct LootItem : IEQStruct {
		/// <summary>
		...
		public LootItem(uint lootee, uint looter, uint slot_id, int auto_loot, uint unknown16) : this() {
			Lootee = lootee;
			Looter = looter;
			SlotId = slot_id;
			AutoLoot = auto_loot;
		...
		public LootItem(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public LootItem(BinaryReader br) : this() {
			Unpack(br);
		}

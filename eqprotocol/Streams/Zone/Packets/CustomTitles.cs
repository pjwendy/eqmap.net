...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct CustomTitles : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the CustomTitles struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public CustomTitles() : this() {
		...
		public CustomTitles(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public CustomTitles(BinaryReader br) : this() {
			Unpack(br);
		}

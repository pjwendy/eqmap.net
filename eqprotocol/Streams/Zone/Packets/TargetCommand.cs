...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct TargetCommand : IEQStruct {
		/// <summary>
		...
		public TargetCommand(uint new_target) : this() {
		...
		public TargetCommand(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public TargetCommand(BinaryReader br) : this() {
			Unpack(br);
		}

...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct LFPGetMatchesResponse : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the LFPGetMatchesResponse struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public LFPGetMatchesResponse() : this() {
		...
		public LFPGetMatchesResponse(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public LFPGetMatchesResponse(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct LFPGetMatchesResponse {\n";
						ret += "	// No properties\n";
			ret += "}";

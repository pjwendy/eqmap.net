...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct PetHoTT : IEQStruct {
		/// <summary>
		...
		public PetHoTT(uint new_target) : this() {
		...
		public PetHoTT(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public PetHoTT(BinaryReader br) : this() {
			Unpack(br);
		}

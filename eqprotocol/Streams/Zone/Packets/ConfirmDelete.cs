...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct ConfirmDelete : IEQStruct {
		/// <summary>
		...
		public ConfirmDelete(uint m_target, uint m_atk, uint m_skill) : this() {
			MTarget = m_target;
			MAtk = m_atk;
			MSkill = m_skill;
		}
		...
		public ConfirmDelete(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public ConfirmDelete(BinaryReader br) : this() {
			Unpack(br);
		}

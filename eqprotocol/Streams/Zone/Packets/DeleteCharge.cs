...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct DeleteCharge : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the DeleteCharge struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public DeleteCharge() : this() {
		...
		public DeleteCharge(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public DeleteCharge(BinaryReader br) : this() {
			Unpack(br);
		}

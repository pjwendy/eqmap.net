...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct ClearNPCMarks : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the ClearNPCMarks struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public ClearNPCMarks() : this() {
		...
		public ClearNPCMarks(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public ClearNPCMarks(BinaryReader br) : this() {
			Unpack(br);
		}

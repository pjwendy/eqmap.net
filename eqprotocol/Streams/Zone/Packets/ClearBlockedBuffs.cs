...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct ClearBlockedBuffs : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the ClearBlockedBuffs struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public ClearBlockedBuffs() : this() {
		...
		public ClearBlockedBuffs(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public ClearBlockedBuffs(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct ClearBlockedBuffs {\n";
						ret += "	// No properties\n";
			ret += "}";

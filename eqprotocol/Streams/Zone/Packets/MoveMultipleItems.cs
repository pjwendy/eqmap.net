...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct MoveMultipleItems : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the MoveMultipleItems struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public MoveMultipleItems() : this() {
		...
		public MoveMultipleItems(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public MoveMultipleItems(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct MoveMultipleItems {\n";
						ret += "	// No properties\n";
			ret += "}";

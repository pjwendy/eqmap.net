...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct TradeMoneyUpdate : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the TradeMoneyUpdate struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public TradeMoneyUpdate() : this() {
		...
		public TradeMoneyUpdate(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public TradeMoneyUpdate(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct TradeMoneyUpdate {\n";
						ret += "	// No properties\n";
			ret += "}";

...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct Stamina : IEQStruct {
		/// <summary>
		...
		public Stamina(uint food, uint water) : this() {
			Food = food;
			Water = water;
		}
		...
		public Stamina(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public Stamina(BinaryReader br) : this() {
			Unpack(br);
		}

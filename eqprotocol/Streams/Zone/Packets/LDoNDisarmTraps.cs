...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct LDoNDisarmTraps : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the LDoNDisarmTraps struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public LDoNDisarmTraps() : this() {
		...
		public LDoNDisarmTraps(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public LDoNDisarmTraps(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct LDoNDisarmTraps {\n";
						ret += "	// No properties\n";
			ret += "}";

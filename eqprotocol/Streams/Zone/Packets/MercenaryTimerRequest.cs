...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct MercenaryTimerRequest : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the MercenaryTimerRequest struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public MercenaryTimerRequest() : this() {
		...
		public MercenaryTimerRequest(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public MercenaryTimerRequest(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct MercenaryTimerRequest {\n";
						ret += "	// No properties\n";
			ret += "}";

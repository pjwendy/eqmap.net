...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct AutoAttack : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the AutoAttack struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public AutoAttack() : this() {
		...
		public AutoAttack(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public AutoAttack(BinaryReader br) : this() {
			Unpack(br);
		}

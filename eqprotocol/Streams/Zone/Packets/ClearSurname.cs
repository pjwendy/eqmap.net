...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct ClearSurname : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the ClearSurname struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public ClearSurname() : this() {
		...
		public ClearSurname(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public ClearSurname(BinaryReader br) : this() {
			Unpack(br);
		}

...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct GuildPublicNote : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the GuildPublicNote struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public GuildPublicNote() : this() {
		...
		public GuildPublicNote(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public GuildPublicNote(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct GuildPublicNote {\n";
						ret += "	// No properties\n";
			ret += "}";

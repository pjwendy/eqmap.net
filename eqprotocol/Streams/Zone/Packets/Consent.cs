...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct Consent : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the Consent struct with specified field values.
		/// </summary>
		...
		public Consent(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public Consent(BinaryReader br) : this() {
			Unpack(br);
		}

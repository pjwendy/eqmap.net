...
namespace OpenEQ.Netcode {
	...
	public struct LDoNOpen : IEQStruct {
		...
		public LDoNOpen(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public LDoNOpen(BinaryReader br) : this() {
			Unpack(br);
		}

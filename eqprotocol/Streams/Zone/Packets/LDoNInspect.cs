...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct LDoNInspect : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the LDoNInspect struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public LDoNInspect() : this() {
		...
		public LDoNInspect(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public LDoNInspect(BinaryReader br) : this() {
			Unpack(br);
		}

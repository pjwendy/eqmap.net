...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct ClientReady : IEQStruct {
		/// <summary>
		...
		public ClientReady(byte type, byte[] character_name, byte[] unknown134, byte[] message) : this() {
			Type = type;
		...
		public ClientReady(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public ClientReady(BinaryReader br) : this() {
			Unpack(br);
		}

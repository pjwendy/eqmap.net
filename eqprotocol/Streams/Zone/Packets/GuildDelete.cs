...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct GuildDelete : IEQStruct {
		/// <summary>
		...
		public GuildDelete(uint guild_id) : this() {
			GuildId = guild_id;
		}
		...
		public GuildDelete(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public GuildDelete(BinaryReader br) : this() {
			Unpack(br);
		}

...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct LFGuild : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the LFGuild struct with specified field values.
		/// </summary>
		...
		public LFGuild(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public LFGuild(BinaryReader br) : this() {
			Unpack(br);
		}

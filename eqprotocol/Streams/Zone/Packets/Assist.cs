...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct Assist : IEQStruct {
		/// <summary>
		...
		public Assist(uint entity_id) : this() {
			EntityId = entity_id;
		}
		...
		public Assist(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public Assist(BinaryReader br) : this() {
			Unpack(br);
		}

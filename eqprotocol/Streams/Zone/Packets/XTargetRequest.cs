...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct XTargetRequest : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the XTargetRequest struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public XTargetRequest() : this() {
		...
		public XTargetRequest(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public XTargetRequest(BinaryReader br) : this() {
			Unpack(br);
		}

...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct RequestDuel : IEQStruct {
		/// <summary>
		...
		public RequestDuel(uint duel_initiator, uint duel_target) : this() {
		...
		public RequestDuel(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public RequestDuel(BinaryReader br) : this() {
			Unpack(br);
		}

...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct AdventureInfo : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the AdventureInfo struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public AdventureInfo() : this() {
		...
		public AdventureInfo(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public AdventureInfo(BinaryReader br) : this() {
			Unpack(br);
		}

...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct TradeAcceptClick : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the TradeAcceptClick struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public TradeAcceptClick() : this() {
		...
		public TradeAcceptClick(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public TradeAcceptClick(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct TradeAcceptClick {\n";
						ret += "	// No properties\n";
			ret += "}";

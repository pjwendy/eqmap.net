...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct LeaveBoat : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the LeaveBoat struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public LeaveBoat() : this() {
		...
		public LeaveBoat(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public LeaveBoat(BinaryReader br) : this() {
			Unpack(br);
		}

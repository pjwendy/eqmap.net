...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct BoardBoat : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the BoardBoat struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public BoardBoat() : this() {
		...
		public BoardBoat(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public BoardBoat(BinaryReader br) : this() {
			Unpack(br);
		}

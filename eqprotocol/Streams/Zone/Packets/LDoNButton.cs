...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct LDoNButton : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the LDoNButton struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public LDoNButton() : this() {
		...
		public LDoNButton(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public LDoNButton(BinaryReader br) : this() {
			Unpack(br);
		}

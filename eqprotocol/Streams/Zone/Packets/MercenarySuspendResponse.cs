...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct MercenarySuspendResponse : IEQStruct {
		/// <summary>
		...
		public MercenarySuspendResponse(uint SuspendTime) : this() {
		...
		public MercenarySuspendResponse(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public MercenarySuspendResponse(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct MercenarySuspendResponse {\n";
			ret += "	Suspendtime = ";
			try {

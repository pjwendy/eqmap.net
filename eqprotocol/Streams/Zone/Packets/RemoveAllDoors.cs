...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct RemoveAllDoors : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the RemoveAllDoors struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public RemoveAllDoors() : this() {
		...
		public RemoveAllDoors(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public RemoveAllDoors(BinaryReader br) : this() {
			Unpack(br);
		}

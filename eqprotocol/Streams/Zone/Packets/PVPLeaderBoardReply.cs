...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct PVPLeaderBoardReply : IEQStruct {
		/// <summary>
		...
		public PVPLeaderBoardReply(uint MyKills, uint MyTotalPoints, uint MyRank, uint MyDeaths, uint MyInfamy, uint[] Entries) : this() {
			Mykills = MyKills;
		...
		public PVPLeaderBoardReply(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public PVPLeaderBoardReply(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct PVPLeaderBoardReply {\n";
			ret += "	Mykills = ";
			try {

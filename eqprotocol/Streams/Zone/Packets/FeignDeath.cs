...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct FeignDeath : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the FeignDeath struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public FeignDeath() : this() {
		...
		public FeignDeath(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public FeignDeath(BinaryReader br) : this() {
			Unpack(br);
		}

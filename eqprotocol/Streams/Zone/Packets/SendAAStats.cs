...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct SendAAStats : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the SendAAStats struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public SendAAStats() : this() {
		...
		public SendAAStats(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public SendAAStats(BinaryReader br) : this() {
			Unpack(br);
		}

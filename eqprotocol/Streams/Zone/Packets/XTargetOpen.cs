...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct XTargetOpen : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the XTargetOpen struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public XTargetOpen() : this() {
		...
		public XTargetOpen(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public XTargetOpen(BinaryReader br) : this() {
			Unpack(br);
		}

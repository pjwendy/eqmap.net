...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct GMServers : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the GMServers struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public GMServers() : this() {
		...
		public GMServers(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public GMServers(BinaryReader br) : this() {
			Unpack(br);
		}

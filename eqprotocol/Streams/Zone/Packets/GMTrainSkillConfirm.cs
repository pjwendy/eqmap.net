...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct GMTrainSkillConfirm : IEQStruct {
		/// <summary>
		...
		public GMTrainSkillConfirm(uint SkillID, uint Cost, byte NewSkill, byte[] TrainerName) : this() {
			Skillid = SkillID;
			Cost = Cost;
			Newskill = NewSkill;
		...
		public GMTrainSkillConfirm(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public GMTrainSkillConfirm(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct GMTrainSkillConfirm {\n";
			ret += "	Skillid = ";
			try {

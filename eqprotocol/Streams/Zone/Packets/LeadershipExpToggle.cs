...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct LeadershipExpToggle : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the LeadershipExpToggle struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public LeadershipExpToggle() : this() {
		...
		public LeadershipExpToggle(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public LeadershipExpToggle(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct LeadershipExpToggle {\n";
						ret += "	// No properties\n";
			ret += "}";

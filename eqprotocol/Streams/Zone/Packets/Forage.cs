...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct Forage : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the Forage struct with specified field values.
		/// </summary>
		...
		public Forage(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public Forage(BinaryReader br) : this() {
			Unpack(br);
		}

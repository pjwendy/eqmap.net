...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct Mend : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the Mend struct with specified field values.
		/// </summary>
		...
		public Mend(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public Mend(BinaryReader br) : this() {
			Unpack(br);
		}

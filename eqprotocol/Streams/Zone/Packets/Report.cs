...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct Report : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the Report struct with specified field values.
		/// </summary>
		...
		public Report(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public Report(BinaryReader br) : this() {
			Unpack(br);
		}

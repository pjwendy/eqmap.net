...
namespace OpenEQ.Netcode {
	...
	internal static class ChatChannel_Helper {
		internal static ChatChannel Unpack(this ChatChannel val, BinaryReader br) {
			switch(br.ReadUInt16()) {
				...
				case 3:
					return ChatChannel.Shout;
				case 4:
					return ChatChannel.Auction;
				case 5:
					return ChatChannel.OOC;
				case 6:
					return ChatChannel.Broadcast;
				case 7:
					return ChatChannel.Tell;
				case 8:
					return ChatChannel.Say;
				case 10:
					return ChatChannel.Petition;
				case 11:
					return ChatChannel.GMSAY;
				case 14:
					return ChatChannel.TellEcho;
				case 15:
					return ChatChannel.Raid;
				case 17:
					return ChatChannel.UNKNOWN_Guild;
				case 18:
					return ChatChannel.UNKNOWN_GMSAY;
				case 20:
					return ChatChannel.UCSRelay;
				default:
					return ChatChannel.Emotes;
			}
		}
	}
    ...
    public struct Autoconsent : IEQStruct
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Autoconsent"/> struct with specified values.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Autoconsent"/> struct from a byte array.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Autoconsent"/> struct from a <see cref="BinaryReader"/>.
		/// </summary>
		...
		/// <summary>
		/// Returns a string representation of the <see cref="Autoconsent"/> struct.
		/// </summary>
	...
	public struct LdonPoints : IEQStruct
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="LdonPoints"/> struct with specified values.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="LdonPoints"/> struct from a byte array.
		/// </summary>
		/// <param name="data">The byte array containing the data.</param>
		/// <param name="offset">The offset in the array.</param>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="LdonPoints"/> struct from a <see cref="BinaryReader"/>.
		/// </summary>
		/// <param name="br">The binary reader.</param>
		...
		/// <summary>
		/// Returns a string representation of the <see cref="LdonPoints"/> struct.
		/// </summary>
		/// <returns>A string describing the struct.</returns>
		public override string ToString()
		{
    ...
    public struct GroupMember : IEQStruct
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupMember"/> struct with the specified name.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupMember"/> struct from a byte array.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupMember"/> struct from a <see cref="BinaryReader"/>.
        /// </summary>
        /// <param name="br">The <see cref="BinaryReader"/> to read the group member data from.</param>
        ...
        /// <summary>
        /// Unpacks the group member data from a <see cref="BinaryReader"/>.
        /// </summary>
        /// <param name="br">The <see cref="BinaryReader"/> to read the group member data from.</param>
        public void Unpack(BinaryReader br)
        {
        ...
        /// <summary>
        /// Packs the group member data into a <see cref="BinaryWriter"/>.
        /// </summary>
        /// <param name="bw">The <see cref="BinaryWriter"/> to write the group member data to.</param>
        public void Pack(BinaryWriter bw)
        {
        ...
        /// <summary>
        /// Returns a string representation of the <see cref="GroupMember"/> struct.
        /// </summary>
        /// <returns>A string that represents the current <see cref="GroupMember"/>.</returns>
        public override string ToString()
        {
    ...
    public struct SerializedItem : IEQStruct
    {
        ...
        public void Unpack(BinaryReader br)
        {
            ...
            // Debug: Name={Name}, SubItemCount={SubItemCount}
	...
	public struct ClientUpdatePositionSub1 : IEQStruct {
		...
		public void Pack(BinaryWriter bw) {
			// Pack DeltaHeading into a 32-bit value (10 bits used)
			uint packed = (uint)(DeltaHeading & 0x3FF);
			bw.Write(packed);
		}
	...
	public struct ClientUpdatePositionSub2 : IEQStruct {
		...
		public void Pack(BinaryWriter bw) {
			// Pack Animation (10 bits) and Heading (12 bits) into a 32-bit value
			uint packed = (uint)(Animation & 0x3FF) | ((uint)(Heading & 0xFFF) << 10);
			bw.Write(packed);
		}
	...
	public struct ZoneChange : IEQStruct {
		...
		public float X;
		public float Z;
		public uint ZoneReason;
		public int Success;

		public ZoneChange(string Name, ushort ZoneID, ushort InstanceId, float Y, float X, float Z, uint ZoneReason, int Success) : this() {
			this.Name = Name;
			this.ZoneID = ZoneID;
			this.InstanceId = InstanceId;
			this.Y = Y;
	...
	public struct DeleteSpawn : IEQStruct {
		...
		public DeleteSpawn(uint SpawnId) : this() {
			this.SpawnId = SpawnId;
		}
	...
	public struct RequestClientZoneChange : IEQStruct {
		...
		public RequestClientZoneChange(ushort ZoneID, ushort InstanceId, float Y, float X, float Z, float Heading) : this() {
			this.ZoneID = ZoneID;
			this.InstanceId = InstanceId;
			this.Y = Y;
			this.X = X;
	...
	public struct SaveOnZoneReq : IEQStruct {
		public byte[] Part1;
		public byte[] Part2;

		public SaveOnZoneReq(byte[] Part1, byte[] Part2) : this() {
			this.Part1 = Part1;
			this.Part2 = Part2;
		}

		public SaveOnZoneReq(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		public SaveOnZoneReq(BinaryReader br) : this() {
			Unpack(br);
		}
		public void Unpack(byte[] data, int offset = 0) {
			using(var ms = new MemoryStream(data, offset, data.Length - offset)) {
	...
	// Additional Underfoot packet structures moved from AdditionalPackets.cs
	...
	public struct Emote
	{
		...
		public Emote(byte[] data, int offset = 0)
		{
			using (var ms = new MemoryStream(data, offset, Math.Min(data.Length - offset, 1036)))
			using (var br = new BinaryReader(ms))
			{
				...
				var messageBytes = br.ReadBytes(1024);
				Message = System.Text.Encoding.ASCII.GetString(messageBytes).TrimEnd('\0');
			}
		}
	}
	...
	{
		public uint Level;     // New level
		public uint LevelOld;  // Old level
		public uint Exp;       // Current Experience
		
		public LevelUpdate(byte[] data, int offset = 0)
		{
			using (var ms = new MemoryStream(data, offset, Math.Min(data.Length - offset, 12)))
			using (var br = new BinaryReader(ms))
			{
				Level = br.ReadUInt32();
	...
	public struct MoveItem
	{
		...
		public MoveItem(byte[] data, int offset = 0)
		{
			using (var ms = new MemoryStream(data, offset, Math.Min(data.Length - offset, 12)))
			using (var br = new BinaryReader(ms))
			{
	...
	[StructLayout(LayoutKind.Sequential, Pack = 1)]
	public struct ClientTarget
	{
		public uint NewTarget; // Target entity ID
		
		public ClientTarget(byte[] data, int offset = 0)
		{
	...
	public struct Charm
	{
		public uint OwnerId;
		public uint PetId;
		public uint Command; // 1: make pet, 0: release pet
		
		public Charm(byte[] data, int offset = 0)
		{
			using (var ms = new MemoryStream(data, offset, Math.Min(data.Length - offset, 12)))
			using (var br = new BinaryReader(ms))
			{
	...
	public struct Stun
	{
		public uint Duration;    // Duration of stun
		public byte Unknown004;  // seen 0
		public byte Unknown005;  // seen 163
		public byte Unknown006;  // seen 67
		public byte Unknown007;  // seen 0
		
		public Stun(byte[] data, int offset = 0)
		{
			using (var ms = new MemoryStream(data, offset, Math.Min(data.Length - offset, 8)))
			using (var br = new BinaryReader(ms))
			{

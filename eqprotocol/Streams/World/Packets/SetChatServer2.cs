...
namespace EQProtocol.Streams.World.Packets {
	...
	/// </summary>
	public struct SetChatServer2 : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the SetChatServer2 struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public SetChatServer2() : this() {
		...
		public SetChatServer2(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public SetChatServer2(BinaryReader br) : this() {
			Unpack(br);
		}

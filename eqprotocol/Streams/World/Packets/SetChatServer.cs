...
namespace EQProtocol.Streams.World.Packets {
	...
	/// </summary>
	public struct SetChatServer : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the SetChatServer struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public SetChatServer() : this() {
		...
		public SetChatServer(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public SetChatServer(BinaryReader br) : this() {
			Unpack(br);
		}

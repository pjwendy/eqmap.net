...
namespace EQProtocol.Streams.World.Packets {
	...
	/// </summary>
	public struct WorldClientReady : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the WorldClientReady struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public WorldClientReady() : this() {
		...
		public WorldClientReady(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public WorldClientReady(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct WorldClientReady {\n";
						ret += "	// No properties\n";
			ret += "}";

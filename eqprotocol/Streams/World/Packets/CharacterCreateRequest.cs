...
namespace EQProtocol.Streams.World.Packets {
	...
	/// </summary>
	public struct CharacterCreateRequest : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the CharacterCreateRequest struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public CharacterCreateRequest() : this() {
		...
		public CharacterCreateRequest(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public CharacterCreateRequest(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct CharacterCreateRequest {\n";
						ret += "	// No properties\n";
			ret += "}";

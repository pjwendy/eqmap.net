...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct SendLoginInfo : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the SendLoginInfo struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public SendLoginInfo() : this() {
		...
		public SendLoginInfo(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public SendLoginInfo(BinaryReader br) : this() {
			Unpack(br);
		}

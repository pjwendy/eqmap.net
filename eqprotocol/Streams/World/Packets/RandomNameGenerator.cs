...
namespace EQProtocol.Streams.World.Packets {
	...
	/// </summary>
	public struct RandomNameGenerator : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the RandomNameGenerator struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public RandomNameGenerator() : this() {
		...
		public RandomNameGenerator(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public RandomNameGenerator(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct RandomNameGenerator {\n";
						ret += "	// No properties\n";
			ret += "}";

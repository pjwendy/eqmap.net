...
namespace OpenEQ.Netcode {
	...
	/// </summary>
	public struct CharacterCreate : IEQStruct {
		/// <summary>
		...
		public CharacterCreate(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public CharacterCreate(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct CharacterCreate {\n";
			ret += "	Class = ";
			try {
				ret += $"{ Indentify(Class) },\n";

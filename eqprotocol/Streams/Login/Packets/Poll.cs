...
namespace EQProtocol.Streams.Login.Packets {
	...
	/// </summary>
	public struct Poll : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the Poll struct with specified field values.
		/// </summary>
		...
		public Poll(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public Poll(BinaryReader br) : this() {
			Unpack(br);
		}

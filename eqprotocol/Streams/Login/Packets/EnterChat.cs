...
namespace EQProtocol.Streams.Login.Packets {
	...
	/// </summary>
	public struct EnterChat : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the EnterChat struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public EnterChat() : this() {
		...
		public EnterChat(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public EnterChat(BinaryReader br) : this() {
			Unpack(br);
		}

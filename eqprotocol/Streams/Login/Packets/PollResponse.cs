...
namespace EQProtocol.Streams.Login.Packets {
	...
	/// </summary>
	public struct PollResponse : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the PollResponse struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public PollResponse() : this() {
		...
		public PollResponse(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public PollResponse(BinaryReader br) : this() {
			Unpack(br);
		}

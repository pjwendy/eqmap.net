...
namespace EQProtocol.Streams.Common.UnUsed_Packets {
	...
	/// </summary>
	public struct ShroudRespondStats : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the ShroudRespondStats struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public ShroudRespondStats() : this() {
		...
		public ShroudRespondStats(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public ShroudRespondStats(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct ShroudRespondStats {\n";
						ret += "	// No properties\n";
			ret += "}";

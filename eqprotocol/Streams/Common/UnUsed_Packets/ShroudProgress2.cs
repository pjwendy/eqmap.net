...
namespace EQProtocol.Streams.Common.UnUsed_Packets {
	...
	/// </summary>
	public struct ShroudProgress2 : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the ShroudProgress2 struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public ShroudProgress2() : this() {
		...
		public ShroudProgress2(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public ShroudProgress2(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct ShroudProgress2 {\n";
						ret += "	// No properties\n";
			ret += "}";

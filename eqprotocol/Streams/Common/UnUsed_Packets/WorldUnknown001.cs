...
namespace EQProtocol.Streams.Common.UnUsed_Packets {
	...
	/// </summary>
	public struct WorldUnknown001 : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the WorldUnknown001 struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public WorldUnknown001() : this() {
		...
		public WorldUnknown001(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public WorldUnknown001(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct WorldUnknown001 {\n";
						ret += "	// No properties\n";
			ret += "}";

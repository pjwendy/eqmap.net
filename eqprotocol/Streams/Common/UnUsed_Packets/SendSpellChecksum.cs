...
namespace EQProtocol.Streams.Common.UnUsed_Packets {
	...
	/// </summary>
	public struct SendSpellChecksum : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the SendSpellChecksum struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public SendSpellChecksum() : this() {
		...
		public SendSpellChecksum(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public SendSpellChecksum(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct SendSpellChecksum {\n";
						ret += "	// No properties\n";
			ret += "}";

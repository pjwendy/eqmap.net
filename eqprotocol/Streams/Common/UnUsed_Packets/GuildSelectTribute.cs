...
namespace EQProtocol.Streams.Common.UnUsed_Packets {
	...
	/// </summary>
	public struct GuildSelectTribute : IEQStruct {
		/// <summary>
		...
		public GuildSelectTribute(uint tribute_id, uint tier, uint tribute_id2, uint unknown12) : this() {
		...
		public GuildSelectTribute(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public GuildSelectTribute(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct GuildSelectTribute {\n";
			ret += "	TributeId = ";
			try {

...
namespace EQProtocol.Streams.Common.UnUsed_Packets {
	...
	/// </summary>
	public struct GuildSaveActiveTributes : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the GuildSaveActiveTributes struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public GuildSaveActiveTributes() : this() {
		...
		public GuildSaveActiveTributes(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public GuildSaveActiveTributes(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct GuildSaveActiveTributes {\n";
						ret += "	// No properties\n";
			ret += "}";

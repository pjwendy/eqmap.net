...
namespace EQProtocol.Streams.Common.UnUsed_Packets {
	...
	/// </summary>
	public struct GuildTributeToggleReq : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the GuildTributeToggleReq struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public GuildTributeToggleReq() : this() {
		...
		public GuildTributeToggleReq(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public GuildTributeToggleReq(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct GuildTributeToggleReq {\n";
						ret += "	// No properties\n";
			ret += "}";

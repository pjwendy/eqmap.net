...
namespace EQProtocol.Streams.Common.UnUsed_Packets {
	...
	/// </summary>
	public struct RemoveTrap : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the RemoveTrap struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public RemoveTrap() : this() {
		...
		public RemoveTrap(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public RemoveTrap(BinaryReader br) : this() {
			Unpack(br);
		}

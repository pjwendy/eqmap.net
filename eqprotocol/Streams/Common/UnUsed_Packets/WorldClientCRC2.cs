...
namespace EQProtocol.Streams.Common.UnUsed_Packets {
	...
	/// </summary>
	public struct WorldClientCRC2 : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the WorldClientCRC2 struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public WorldClientCRC2() : this() {
		...
		public WorldClientCRC2(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public WorldClientCRC2(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct WorldClientCRC2 {\n";
						ret += "	// No properties\n";
			ret += "}";

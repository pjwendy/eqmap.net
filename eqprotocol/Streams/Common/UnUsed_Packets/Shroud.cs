...
namespace EQProtocol.Streams.Common.UnUsed_Packets {
	...
	/// </summary>
	public struct Shroud : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the Shroud struct with specified field values.
		/// </summary>
		...
		public Shroud(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public Shroud(BinaryReader br) : this() {
			Unpack(br);
		}

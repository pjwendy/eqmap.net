...
namespace EQProtocol.Streams.Common.UnUsed_Packets {
	...
	/// </summary>
	public struct GuildTributeToggleReply : IEQStruct {
		/// <summary>
		...
		public GuildTributeToggleReply(uint not_used, uint guild_favor, uint tribute_timer, uint tribute_enabled, byte[] unknown16, uint tribute_id_1, uint tribute_id_2, uint tribute_id_1_tier, uint tribute_id_2_tier) : this() {
			NotUsed = not_used;
		...
		public GuildTributeToggleReply(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public GuildTributeToggleReply(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct GuildTributeToggleReply {\n";
			ret += "	NotUsed = ";
			try {

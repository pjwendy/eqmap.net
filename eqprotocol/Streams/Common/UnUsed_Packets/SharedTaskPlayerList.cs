...
namespace EQProtocol.Streams.Common.UnUsed_Packets {
	...
	/// </summary>
	public struct SharedTaskPlayerList : IEQStruct {
				// No properties - structure definition not found or empty

		/// <summary>
		/// Initializes a new instance of the SharedTaskPlayerList struct with specified field values.
		/// </summary>
		// C# 8.0: Parameterless struct constructors not supported - uncomment if using C# 10.0+
		// public SharedTaskPlayerList() : this() {
		...
		public SharedTaskPlayerList(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public SharedTaskPlayerList(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct SharedTaskPlayerList {\n";
						ret += "	// No properties\n";
			ret += "}";

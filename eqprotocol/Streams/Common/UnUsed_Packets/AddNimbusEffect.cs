...
namespace EQProtocol.Streams.Common.UnUsed_Packets {
	...
	/// </summary>
	public struct AddNimbusEffect : IEQStruct {
		/// <summary>
		...
		public AddNimbusEffect(uint spawnid, int nimbus_effect) : this() {
			Spawnid = spawnid;
		...
		public AddNimbusEffect(byte[] data, int offset = 0) : this() {
			Unpack(data, offset);
		}
		...
		public AddNimbusEffect(BinaryReader br) : this() {
			Unpack(br);
		}
		...
		public override string ToString() {
			var ret = "struct AddNimbusEffect {\n";
			ret += "	Spawnid = ";
			try {
